...
export const HeroSection = () => {
  return (
    <div className="cover bg-blue-teal-gradient relative bg-blue-600 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex items-center min-h-screen">
      <div className="h-screen absolute top-0 left-0 z-0">
        <img
          src={coverBg}
          alt="Cover"
      ...
      <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
        <div>
          ...
          <p className="text-blue-100 text-xl md:text-2xl leading-snug mt-4">
            Your child’ s journey to confidence, knowledge, and a brighter
            future begins here— with the care and guidance every family
            deserves.
          </p>
          <a
            href="/Enrollment"
