                            ...
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #5d77a9; color: #000000; width: 680px; margin: 0 auto;"
                                        width="680">
                                        <tbody>
                                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #cbdbef; color: #000000; width: 680px; margin: 0 auto;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <div class="spacer_block block-1"
                                                        style="height:80px;line-height:80px;font-size:1px;">&#8202;
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            <tr class="reverse">
                                                <td class="column column-1 first" width="100%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top;">
                                                    <div class="border">
                                                        <table class="paragraph_block block-1" width="100%"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        style="color:#2f2f2f;font-family:Georgia,Times,'Times New Roman',serif;font-size:42px;line-height:1.2;text-align:center;mso-line-height-alt:50px;">
                                                                        <p style="margin: 0; word-break: break-word;">
                                                                            <span
                                                                                style="word-break: break-word;">&nbsp;</span><span
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0;">Click the button to reset password</p>
                                                                        <p style="margin: 0; word-break: break-word;">
                                                                            &nbsp;</p>
                                                                        <p style="margin: 0; word-break: break-word;">
                                                                            &nbsp;</p>
                                                        ...
                                                        <a href="{{ $link }}">
                                                            <table class="button_block block-3" width="100%"
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"   style="height:42px;width:96px;v-text-anchor:middle;" arcsize="10%" fillcolor="#000e60">
<v:stroke dashstyle="Solid" weight="0px" color="#000e60"/>
<w:anchorlock/>
...
<center dir="false" style="color:#ffffff;font-family:Arial, sans-serif;font-size:16px">
    ...
    <![endif]--><span class="button" style="background-color: #000e60; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 4px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; font-weight: 400; mso-border-alt: none; padding-bottom: 5px; padding-top: 5px; padding-left: 20px; padding-right: 20px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><span
                                                                                    style="word-break: break-word; line-height: 32px;">Confirm</span></span><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #cbdbef; color: #000000; background-image: url('https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4951/background-reminder.jpg'); background-repeat: repeat; width: 680px; margin: 0 auto;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center">
                                                                    <div class="fullWidth" style="max-width: 680px;">
                                                                        <img src="https://images.unsplash.com/photo-1568585262983-9b54814595a9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="680" alt="kids"
                                                                            title="kids" height="auto">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
